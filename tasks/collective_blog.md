...
Подумайте, какие нам здесь необходимы сущности и как мы их можем описать. Сделайте несколько примеров в виде JSON.

### Скелет приложения

* Сделайте основу express-приложения
* Корректно подключите ejs к express
* Сделайте заглушки для маршрутов (сами маршруты описаны в заголовке каждой страницы)
